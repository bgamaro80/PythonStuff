...
class Pycalc(Frame):
    ...
    def createWidgets(self):
        self.display = Entry(self, font=("Arial", 32), relief=RAISED, justify=RIGHT, bg='darkblue', fg='red', borderwidth=0)
        ...
        self.delButton = Button(self, font=("Arial", 12), fg='black', text="Del", highlightbackground='red', command=lambda: self.deleteLastCharacter())
